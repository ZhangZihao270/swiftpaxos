...
# Exp 1.1 (Final): Raft-HT vs Raft — Throughput vs Latency
#
...
#
# Usage: bash scripts/eval-exp1.1-final.sh [output-dir]
...
CONFIG="/tmp/eval-exp1.1-final-$$.conf"
...
log "Exp 1.1 (Final): Raft-HT vs Raft — Throughput vs Latency"
...
SUMMARY_CSV="$BASE_DIR/summary-exp1.1.csv"
