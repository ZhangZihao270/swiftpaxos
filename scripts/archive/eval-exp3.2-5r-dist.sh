...
# Exp 3.2 (5-Replica): T Property Verification — Weak Ratio Sweep
#
# Same as eval-exp3.2-dist.sh but with 5 replicas on 3 machines (2-1-2 layout):
#   .101: replica0, replica1
#   .103: replica2
#   .104: replica3, replica4
#
# Sweeps weak proportion for 3 protocols at fixed concurrency,
...
#
# Usage: bash scripts/eval-exp3.2-5r-dist.sh [output-dir]
...
CONFIG="/tmp/eval-exp3.2-5r-dist-$$.conf"
...
log "Exp 3.2 (5-Replica Distributed): T Property Verification (Weak Ratio Sweep)"
...
log ""
log "Exp 3.2 (5-Replica) complete! Results: $BASE_DIR/summary-exp3.2.csv"
