...
# Exp 3.1 (5-Replica): CURP-HO vs CURP-HT vs Vanilla CURP — Throughput vs Latency
#
# Same as eval-exp3.1-dist.sh but with 5 replicas on 3 machines (2-1-2 layout):
#   .101: replica0, replica1
#   .103: replica2
#   .104: replica3, replica4
#
# Workload: 95/5 read/write, 50/50 strong/weak (0% weak for vanilla CURP).
#
# Usage: bash scripts/eval-exp3.1-5r-dist.sh [output-dir]
# Output: results/eval-5r-YYYYMMDD/exp3.1/
...
CONFIG="/tmp/eval-exp3.1-5r-dist-$$.conf"
...
log "Exp 3.1 (5-Replica Distributed): CURP Throughput vs Latency"
...
log ""
log "Exp 3.1 (5-Replica) complete! Results: $BASE_DIR/summary-exp3.1.csv"
