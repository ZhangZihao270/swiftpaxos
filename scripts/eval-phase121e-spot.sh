...
# Phase 121e: Spot test — Pileus-HT at w5%, weakRatio=50%, t={1,8,32,96}
#
...
DATE=$(date +%Y%m%d)
BASE_DIR="${1:-results/eval-5r5m3c-phase121e-$DATE}"
MAX_RETRIES=3
...
log "Phase 121e: Spot test — Pileus-HT (w5%, weakRatio=50%)"
log "Output: $BASE_DIR"
echo ""
...
for threads in "${THREAD_COUNTS[@]}"; do
    ...
    config="/tmp/eval-phase121e-pileusht-${threads}-$$.conf"
...
echo ""
log "=========================================="
log "Phase 121e Results (w5%, weakRatio=50%)"
log ""
...
log ""
log "Phase 120j reference (w5%): Raft-HT t=96=33.5K, Pileus t=96=35.7K, Mongo t=96=32.6K"
log "Expected: Pileus-HT ≈ Raft-HT (same engine, same fast weak write path)"
log "=========================================="
