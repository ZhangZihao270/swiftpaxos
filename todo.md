...
- [ ] **49.8a** Run Raft-HT benchmark sweep: `nohup bash scripts/run-phase49-sweep.sh &`
- [ ] **49.8b** Run vanilla Raft baseline: `nohup bash scripts/run-phase49-raft-baseline.sh &`
- [ ] **49.8c** Record results in `evaluation/phase49-raftht-results.md` (auto-generated by sweep script)
